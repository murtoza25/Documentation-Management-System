...
<?php
   if(isset($_GET['del_id'])){
       ...
       header("Location:users.php?source=view_unconfirmed_user");
...
<div class="col-xs-12">
 ...
 <table class="table">
  ...
  <tbody>
   <?php  $query="select * from student where status='unconfirmed' order by id desc ";  
      ...
      while($row=mysqli_fetch_assoc($select_user)){
         ...
         $status=(escape($row['status']));    
          ...
          echo "<td>$address</td>";
          echo "<td>$mobile</td>";
          echo "<td><a href='users.php?source=view_unconfirmed_user&status={$status}&status_id={$id}'>$status</a></td>";
     ...
     if($status=="confirmed"){
          ...
          echo "<td><a href='users.php?source=view_unconfirmed_user&del_id={$id}'>Delete</a></td>";
          echo "<td><a href='users.php?source=view_unconfirmed_useredit_user&user_id={$id}'>Edit</a></td>";
