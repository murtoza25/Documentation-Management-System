   ...
   <?php  $query="select * from news order by id desc";  
      ...
      while($row=mysqli_fetch_assoc($select_news)){
        ...
        echo "<th scope='row'> $id</th>";
          ...
          echo "<td>$title</td>";
          echo "<td>$content</td>";
          echo "<td><a href='news.php?source=&status={$status}&status_id={$id}'>$status</a></td>";
          ...
          if(isset($_GET['status_id'])){
              ...
              $status=$_GET['status'];
              if($status=="draft"){
                  $query="update news set status='published' where id='$status_id'";
                  $res=mysqli_query($con,$query);
                  header("Location:./news.php?source=");
              }
     
     if($status=="published"){
                  $query="update news set status='draft' where id='$status_id'";
                  $res=mysqli_query($con,$query);
                  header("Location:./news.php?source=");
              }
          }
          ...
          echo "<td>$author</td>";
          echo "<td><a href='news.php?source=&del_id={$id}'>Delete</a></td>";
          echo "<td><a href='news.php?source=edit_news&news_id={$id}'>Edit</a></td>";
