      ...
      <form action="search_news.php" method="post">
        <div class="inner-form">
          <div class="input-field first-wrap">
            ...
            <input id="search" type="text" placeholder="Search News" name="search" />
          </div>
  ...
  <?php
             if(isset($_POST['search_submit'])){
                 ...
                 if(!empty($search)){
                  ...
                  $query="select * from news where tags like '%$search%' ";
    ...
    <a class="news_link" href="single_news.php?single_news=<?php echo $id ; ?>">
        <div class="news_body">
        <p class="date"><?php echo $date ; ?></p>
        <p class="news_body_header"><?php echo $title; ?></p>
    </div>
    </a>
